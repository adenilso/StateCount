...
//Gera diversas fsms e salva em arquivos.
//as fsms geradas são reduzidas
//aplica o State Counting e gera os conjuntos. Ex: 1_T.in
...
//  char * fsmfile = argv[7];	//arq. que grava as 100 fsm mutantes nao matadas pelo TC para cada FSM
  srand(seed);
